...
exports.listAllTasks = exports.createTask = void 0;
...
var createTask = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, title, description, hour, date;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, userId = _a.userId, title = _a.title, description = _a.description, hour = _a.hour;
